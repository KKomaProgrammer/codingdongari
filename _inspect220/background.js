...
async function _0x0098() {
    const _0x0099 = await EntrySettingsFetch.fetchStatus();
    await _0x0090(_0x0099.accessMode);
    return _0x0099;
}
function _0x009a() {
    if (_0x000e)
...
async function _0x01af() {
    ...
    const _0x01b1 = chrome.runtime.getURL(`updater.html?version=${encodeURIComponent(_0x01b0.version)}`);
