...
const _0x0350 = 'realtime:els-chat-notify-name-';
...
function _0x0079({ code: _0x007a, name: _0x007b, leaderId: _0x007c, leaderName: _0x007d, isLeader: _0x007e, status: _0x007f = 'connecting', members: _0x0306 = [] }) {
    const _0x0080 = {
        code: _0x007a,
...
async function _0x0086() {
    ...
    try { await _0x0005.ensureChannel(await _0x0351(_0x0004.name)); } catch (_) { }
}
...
async function _0x0351(_0x0352) {
